...
//! Core modules used by programs
#include "core/mod.h"
//! The program class defintions
#include "program/mod.h"

/*
// These functions are here just to trampoline into the actual main functions for a given program.
// This additional layer of calls is present to allow for linking to these calls as device functions.
*/
